...
public class TutorDP 
{
	...
	{
		return "seq_tutor.nextval,'"+this.idAlumno+"','"+this.nombre+"','"+this.direccion+"','"+this.telefono+"','"
				+this.email+"', TO_DATE('"+this.fechaNacimiento+"', 'dd/mm/YYYY'),'"+this.parentezco+"','"+this.idEscuela+"'";
	}
