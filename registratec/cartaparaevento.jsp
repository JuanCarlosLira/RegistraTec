...
<html>
    ...
    <body onload="menuEventos();menuFiles();">
        <script>
        ...
        <div class="container">
            <div class="container">
                <h3>Cartas responsivas para un evento</h3>
                <form id="cartas">
                    <div class="row">
                        <div class="col m6">
                        ...
                        <div class="col m6">
                            ...
                            <div class="input-group">
                                <select name="carta" id="carta">
                                    <option value="" disabled>Seleccione un archivo</option>           
                                </select>
                                <label>Lugar</label>
                            </div>
                        </div>
                    </div>
                    <input type="button" name="action" value="Registrar" class="btn waves-effect waves-light"  onclick="linkFiles()" id="ev">
                </form>
            </div>
        </div>                   
    </body>
