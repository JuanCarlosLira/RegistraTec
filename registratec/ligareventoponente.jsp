...
<html>
    ...
    <body onload="menuEventos();">
        ...
        <div class="container">
            <div class="container">
                <h3>Seleccionar ponentes para evento</h3>
                <form id="ponenteRegistro">
                    <div class="row">
                        <div class="col m6">
                            <h5>Eventos disponibles</h5>
                            <div class="input-group">
                                <select name="idEve" id="idEve">
                        ...
                        <div class="col m6">
                            <h5>Ponentes disponibles</h5>
                            <div class="input-group">
                                <select name="idPon" id="idPon">
                                    <option value="" disabled>Seleccione un ponente</option>           
                                </select>
                                <label>Lugar</label>
                            </div>
                        </div>
                    </div>
                    <input type="button" name="action" value="Registrar" class="btn waves-effect waves-light"  onclick="linkPonent()" id="ev">
                </form>
            </div>
        </div>                   
    </body>
