    ...
    <body>
        ...
        <div class="container">
            <div class="container">
                ...
                <form id="ponentForm">
                    <label>Nombre de ponente</label>
                    <input type="text" name="nombre" required>
                     <label>Dirección de ponente</label>
                    <input type="text" name="dir" required>
                    <label>Teléfono de ponente</label>
                    <input type="text" name="tel" required>
                    <label>E-mail de ponente</label>
                    <input type="text" name="mail" required>
                    <input type="button" name="action" value="Registrar ponente" class="btn waves-effect waves-light"  onclick="crearPonente();" id="po">
                </form>
            </div>
        </div>                   
    </body>
