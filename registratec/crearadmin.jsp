...
<html>
    ...
    <body onload="menuDeptos();">
        ...
        <div class="container">
            <div class="container">
                <h3>Creación de directores</h3>
                <form id="adminForm">
                    <div class="input-field">
                        <label for="idAdmin">Numero de Nómina</label>
                        <input type="text" maxlength="15" name="idAdmin" required>
                    </div>
                    <div class="input-field">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" maxlength="60" name="dire" required>
                    </div>
                    <div class="input-field">
                        <label for="tel">Teléfono</label>
                        <input type="text" maxlength="20" name="tel" required>
                    </div>
                    <div class="input-field">
                        <label for="mail">Email</label>
                        <input type="text" maxlength="20" name="mail" required>
                    </div>

                    <label for="fecNac">Fecha de nacimiento</label>
                    <input type="date" name="fecNac" required pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}">

                    <div class="input-field">
                        <label for="tel">Posición</label>
                        <input type="text" maxlength="20" name="pos" required>
                    </div>
                    ...
                    <input type="button" name="action" value="Registrar alumno" class="btn waves-effect waves-light"  onclick="crearAdmin()" id="ev">
