            ...
            <div class="container">
                ...
                <form id="deptForm">
                    <div class="input-field">
                        <label>Nombre</label>
                        <input type="text" maxlength="30" name="depto" required>
                    </div>
                    <input type="button" name="action" value="Registrar departamento" class="btn waves-effect waves-light"  onclick="crearDepto();" id="ev">
                </form>
            </div>
        </div>                   
    </body>
