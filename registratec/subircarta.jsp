...
<html>
    ...
    <body>
        <script>
            $(document).ready(function(){
                $('#upload').on('click', function() {
                        ...
                        $.ajax({
                            url: 'FileLoader.jsp',
                            dataType: 'text',  // what to expect back from the JSP
                            cache: false,
                            contentType: false,
                            processData: false,
                            data: form_data,                         
                        ...
                        <li id="" class="bold"><a class="collapsible-header"><i class=""></i>Eventos</a>
                            <div class="collapsible-body">
                                <ul>
                                    ...
                                    <li class="bold"><a href="subircarta.jsp">Subir carta</a></li><li class="bold"><a href="cartaparaevento.jsp">Añadir carta</a></li><li class="bold"><a href="cartaparaevento.jsp">Añadir carta</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
        ...
        <div class="container">
            <div class="container">
                <h3>Subir cartas responsivas</h3>
                <form>
                    <div class="input-group">
                        <input type="file" name="file" accept=".doc,.docx,.pdf" id="file">
                        <label for="file"></label>
                        <br><br>
                    </div>
                    <hr>
                    <input type="button" value="Subir archivo" class="btn waves-effect waves-light" id="upload"> 
                </form>
            </div>
        </div>                   
    </body>
